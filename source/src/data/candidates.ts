...
export const INITIAL_CANDIDATES: Candidate[] = [
  {
    ...
    regionalCount: 2,
    wfCount: 0,
    topicScores: { math: 9, "number theory": 8, greedy: 7 },
    achievements: [
  ...
  },
  {
    ...
    regionalCount: 1,
    wfCount: 0,
    topicScores: { "data structures": 9, graphs: 8, implementation: 9 },
    achievements: [
  ...
  },
  {
    ...
    regionalCount: 3,
    wfCount: 1,
    topicScores: { dp: 7, graphs: 8, "binary search": 8 },
    achievements: [
  ...
  },
  {
    ...
    regionalCount: 0,
    wfCount: 0,
    topicScores: { math: 8, geometry: 8, "number theory": 7 },
    achievements: [
  ...
  },
  {
    ...
    regionalCount: 4,
    wfCount: 2,
    topicScores: { implementation: 9, "data structures": 8, "two pointers": 9 },
    achievements: [
  ...
  },
  {
    ...
    regionalCount: 1,
    wfCount: 0,
    topicScores: { math: 9, dp: 8, graphs: 8, geometry: 9 },
    achievements: [
  ...
  },
  {
    ...
    regionalCount: 0,
    wfCount: 0,
    topicScores: { implementation: 4, "brute force": 3 },
    achievements: [],
  ...
  },
  {
    ...
    regionalCount: 2,
    wfCount: 0,
    topicScores: { graphs: 8, "data structures": 8, dp: 6 },
    achievements: [
  ...
  },
  {
    ...
    regionalCount: 6,
    wfCount: 0,
    topicScores: { math: 8, dp: 8, geometry: 8 },
    achievements: [
  ...
  },
  {
    ...
    regionalCount: 0,
    wfCount: 3,
    topicScores: { math: 9, "number theory": 9 },
    achievements: [
  ...
  },
  {
    ...
    regionalCount: 1,
    wfCount: 0,
    topicScores: { greedy: 6, implementation: 6, strings: 6 },
    achievements: [],
  ...
  },
  {
    ...
    regionalCount: 2,
    wfCount: 0,
    topicScores: { "data structures": 7, "two pointers": 7 },
    achievements: [],
  ...
  },
  {
    ...
    regionalCount: 0,
    wfCount: 1,
    topicScores: { math: 8, geometry: 7, "number theory": 8 },
    achievements: [
      { competition: "VMO (HSG Quốc gia môn Toán)", level: "Quốc gia", year: 2021, result: "Giải Khuyến khích" },
  ...
  },
  {
    ...
    regionalCount: 1,
    wfCount: 0,
    topicScores: { implementation: 5, greedy: 5, "brute force": 4 },
    achievements: [],
  ...
  },
  {
    ...
    regionalCount: 0,
    wfCount: 0,
    topicScores: { math: 9, dp: 9, graphs: 9, geometry: 9 },
    achievements: [
  ...
  },
  {
    ...
    regionalCount: 1,
    wfCount: 0,
    topicScores: { graphs: 8, "data structures": 8, "binary search": 8 },
    achievements: [
  ...
  },
  {
    ...
    regionalCount: 0,
    wfCount: 0,
    topicScores: { strings: 9, "data structures": 9, "constructive algorithms": 8 },
    achievements: [
  ...
  },
  {
    ...
    regionalCount: 3,
    wfCount: 1,
    topicScores: { math: 7, dp: 7, games: 8, "number theory": 7 },
    achievements: [
