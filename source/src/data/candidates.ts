...
export const SCHOOL_HCMUS = "Trường ĐH Khoa học Tự nhiên, ĐHQG-HCM";
export const SCHOOL_HCMUT = "Trường ĐH Bách Khoa, ĐHQG-HCM";

// Dữ liệu giả lập (mock data), minh bạch, không chứa thông tin nhạy cảm (dân tộc/tôn giáo/chính trị).
// Cố ý xen vài hồ sơ vượt giới hạn Regional/WF và vài hồ sơ trường khác để việc thay đổi ràng buộc
// ở bước 5-6 của core flow có thể tạo ra khác biệt kết quả thấy được, kể cả trường hợp vô nghiệm.
export const INITIAL_CANDIDATES: Candidate[] = [
  ...
  },
  {
    ...
    mssv: "20520016",
    email: "quyenchu.sv20@hcmut.edu.vn",
    school: SCHOOL_HCMUT,
    mathScore: 9,
    codingScore: 9,
    regionalCount: 0,
  ...
  },
  {
    ...
    mssv: "20520017",
    email: "rindinh.sv20@hcmut.edu.vn",
    school: SCHOOL_HCMUT,
    mathScore: 8,
    codingScore: 8,
    regionalCount: 1,
  ...
  },
  {
    ...
    mssv: "20520018",
    email: "suongmai.sv20@hcmut.edu.vn",
    school: SCHOOL_HCMUT,
    mathScore: 7,
    codingScore: 9,
    regionalCount: 0,
